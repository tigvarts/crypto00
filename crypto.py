...
parser.add_argument('--public_key', help='set name of file containing public key for generating KEK')
parser.add_argument('--CEK', help='set name of file containing CEK for key wrapping')
